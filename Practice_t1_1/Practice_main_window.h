...
namespace Practicet11 {
	...
	/// <summary>
	/// Summary for Practice_main_window
	/// </summary>
	public ref class Practice_main_window : public System::Windows::Forms::Form
	{
	public:
		Practice_main_window(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btn_clear->Click += gcnew System::EventHandler(this, &Practice_main_window::btn_clear_Click);
			// 
			// btn_calculate
			// 
			...
			this->btn_calculate->Click += gcnew System::EventHandler(this, &Practice_main_window::btn_calculate_Click);
			// 
			...
			this->Name = L"Practice_main_window";
			this->Text = L"Factorial Calculation";
